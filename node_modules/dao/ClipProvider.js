...
ClipProvider.prototype.getRandomClips = function()
{
	...
	for (var k in this.audioMap) {
		if (this.audioMap[k]["random"] == null || this.audioMap[k]["random"] == true)
			keys.push(k);
	}
...
ClipProvider.prototype.audioMap =
{
	...
	'VAW': {path: '/audio/VAW', duration: '1855', message: 'Wait for my signal before attacking.'},
	...
	'BPS': {path: '/audio/BPS', duration: '800', message: 'Blue Plate Special!', random: false}
};
